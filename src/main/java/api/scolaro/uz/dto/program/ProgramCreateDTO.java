...
//    @Size(min = 3, message = "Description length must be at least 3 characters")
    ...
    @NotBlank(message = "Tuition Fees Description Uz bo‘sh bo‘lishi mumkin emas")
    ...
    @NotBlank(message = "Scholarship Description Uz bo‘sh bo‘lishi mumkin emas")
    ...
    @NotBlank(message = "Cost Of Living Description Uz bo‘sh bo‘lishi mumkin emas")
