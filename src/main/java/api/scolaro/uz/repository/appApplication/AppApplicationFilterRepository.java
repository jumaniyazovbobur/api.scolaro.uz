...
//            dto.setAppVisible(MapperUtil.getVisibleValue(object[2]));
    ...
    public FilterResultDTO<AppApplicationFilterMapperDTO> getForStudent_mobile(int page, int size) {
        StringBuilder stringBuilder = new StringBuilder();
        Map<String, Object> params = new HashMap<>();
        ...
        StringBuilder selectBuilder = new StringBuilder("select " +
                ...
                "       a.created_date as appCreatedDate, " +
                "       a.status       as appStatus, " +
                "       a.application_step_level_status  as applicationStepLevelStatus, " +
                "       c.id           as conId, " +
                "       c.name         as conName, " +
                "       c.photo_id     as conPhotoId " +
                " from app_application as a " +
    ...
    public FilterResultDTO<AppApplicationFilterMapperDTO> getConsultingApplicationListForStudent(String consultingId, int page, int size) {
        StringBuilder stringBuilder = new StringBuilder();
        Map<String, Object> params = new HashMap<>();

        stringBuilder.append(" and a.consulting_id =:consultingId");
