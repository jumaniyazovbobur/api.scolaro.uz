...
public class InstituteService {
    ...
    public ApiResponse<InstituteResponseAdminDTO> create(InstituteRequestDTO dto) {
        ...
        List<InstituteDestinationResponseDTO> destinationResponseDTOList = instituteDestinationService.merge(institute.getId(), dto.getInstituteDestinationRequestDTOS());
        ...
        return new ApiResponse<>("Institute create successfully", 201, false, adminDTO);
    }
